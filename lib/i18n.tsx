  ...
  en: {
    ...
    instructions: {
      ...
      items: [
        ...
        'You can zoom in/out using your browser (Ctrl +/− on desktop, pinch on mobile) to view images at a comfortable size.',
      ],
  ...
  sv: {
    ...
    instructions: {
      ...
      items: [
        ...
        'Du kan zooma in/ut i webbläsaren (Ctrl +/− på dator, nyp på mobil) för att se bilderna i en bekväm storlek.',
      ],
  ...
  zh: {
    ...
    instructions: {
      ...
      items: [
        ...
        '可以使用浏览器缩放（电脑：Ctrl +/−，手机：双指捏合）将图片调整到方便观看的大小。',
      ],
